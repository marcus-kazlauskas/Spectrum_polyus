...
double beta(double teta, double lambda0, double lambda){
    return pi*cos(teta)*lambda0/(2*lambda);
}
...
public:
    ...
    void setTE(double n, double teta1, double lambda0, double lambda){
        mE[0][0].real(cos(beta(teta(teta1, n), lambda0, lambda)));
        mE[0][0].imag(0);
        mE[0][1].real(0);
    ...
    void setTM(double n, double teta1, double lambda0, double lambda){
        mM[0][0].real(cos(beta(teta(teta1, n), lambda0, lambda)));
        mM[0][0].imag(0);
        mM[0][1].real(0);
